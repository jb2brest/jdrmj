...
// Seuls les joueurs candidatent, mais un MJ connect comme joueur peut aussi voir
$player_id = $_SESSION['user_id'];

// Postuler e une campagne publique
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['campaign_id'])) {
    ...
    if ($stmt->fetch()) {
        // Empêcher candidatures multiples
        $stmt = $pdo->prepare("INSERT INTO campaign_applications (campaign_id, player_id, message) VALUES (?, ?, ?) ON DUPLICATE KEY UPDATE message = VALUES(message), status = 'pending'");
        $stmt->execute([$campaign_id, $player_id, $message]);
...
<head>
    ...
    <title>Campagnes Publiques - JDR 4 MJ</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="public_campaigns.php">Campagnes Publiques</a></li>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto d-flex justify-content-between align-items-center">
                                    ...
                                    <?php if ($status === 'pending'): ?>
                                        <span class="badge bg-warning">Candidature en attente</span>
                                ...
                                <div class="modal-content">
                                    <form method="POST">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Postuler e la campagne</h5>
