<?php
/**
 * Script pour corriger les IDs incorrects dans l'équipement du Magicien
 */
...
try {
    ...
    echo "=== CORRECTION DES IDs DE L'ÉQUIPEMENT DU MAGICIEN ===\n\n";
    
    // Corrections à effectuer
    $corrections = [
        // ID 159: Bâton (ID incorrect: 15, correct: 1)
        ['id' => 159, 'type_id' => 1, 'description' => 'Bâton']
    ];
    ...
    $stmt = $pdo->query("
        ...
        WHERE se.src = 'class' AND se.src_id = 7 
        AND se.id IN (159)
        ORDER BY se.id
    ");
