<?php
/**
 * Script pour corriger les IDs incorrects dans l'équipement du Moine
 */
...
try {
    ...
    echo "=== CORRECTION DES IDs DE L'ÉQUIPEMENT DU MOINE ===\n\n";
    
    // Corrections à effectuer
    $corrections = [
        // ID 179: Épée courte (ID incorrect: 16, correct: 18)
        ['id' => 179, 'type_id' => 18, 'description' => 'Épée courte']
    ];
    ...
    $stmt = $pdo->query("
        ...
        WHERE se.src = 'class' AND se.src_id = 8 
        AND se.id IN (179)
        ORDER BY se.id
    ");
