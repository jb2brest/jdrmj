...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     ...
     AND COLUMN_NAME = 'ability_score_bonus') = 0,
    'ALTER TABLE races ADD COLUMN ability_score_bonus VARCHAR(100) AFTER description',
    'SELECT "Colonne ability_score_bonus existe déjà" as message'
));
...
-- Table des classes D&D (si elle n'existe pas)
...
-- Table des historiques/backgrounds (si elle n'existe pas)
...
-- Table des langues (si elle n'existe pas)
...
-- Table des niveaux d'expérience (si elle n'existe pas)
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     ...
     AND COLUMN_NAME = 'background_id') = 0,
    'ALTER TABLE characters ADD COLUMN background_id INT DEFAULT NULL AFTER class_id',
    'SELECT "Colonne background_id existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     WHERE TABLE_SCHEMA = 'u839591438_jdrmj' 
     AND TABLE_NAME = 'characters' 
     AND COLUMN_NAME = 'proficiency_bonus') = 0,
    'ALTER TABLE characters ADD COLUMN proficiency_bonus INT DEFAULT 2 AFTER languages',
    'SELECT "Colonne proficiency_bonus existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     WHERE TABLE_SCHEMA = 'u839591438_jdrmj' 
     AND TABLE_NAME = 'characters' 
     AND COLUMN_NAME = 'saving_throws') = 0,
    'ALTER TABLE characters ADD COLUMN saving_throws TEXT AFTER proficiency_bonus',
    'SELECT "Colonne saving_throws existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    ...
    'SELECT "Colonne skills existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     WHERE TABLE_SCHEMA = 'u839591438_jdrmj' 
     AND TABLE_NAME = 'characters' 
     AND COLUMN_NAME = 'spells_known') = 0,
    'ALTER TABLE characters ADD COLUMN spells_known TEXT AFTER flaws',
    'SELECT "Colonne spells_known existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.COLUMNS 
     WHERE TABLE_SCHEMA = 'u839591438_jdrmj' 
     AND TABLE_NAME = 'characters' 
     AND COLUMN_NAME = 'spell_slots') = 0,
    'ALTER TABLE characters ADD COLUMN spell_slots TEXT AFTER spells_known',
    'SELECT "Colonne spell_slots existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- (Ces commandes peuvent échouer si les contraintes existent déjà, c'est normal)
SET @sql = (SELECT IF(
    (SELECT COUNT(*) FROM information_schema.KEY_COLUMN_USAGE 
     WHERE TABLE_SCHEMA = 'u839591438_jdrmj' 
     AND TABLE_NAME = 'characters' 
     AND CONSTRAINT_NAME = 'characters_ibfk_4') = 0,
    'ALTER TABLE characters ADD CONSTRAINT characters_ibfk_4 FOREIGN KEY (background_id) REFERENCES backgrounds(id)',
    'SELECT "Contrainte background_id existe déjà" as message'
));
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;
...
-- Table des campagnes (si elle n'existe pas)
...
-- Table des membres de campagne (si elle n'existe pas)
...
-- Table des candidatures aux campagnes (si elle n'existe pas)
...
-- Table des sessions de jeu (si elle n'existe pas)
...
-- Table des inscriptions aux sessions (si elle n'existe pas)
...
-- Table des scènes (si elle n'existe pas)
...
-- Table des joueurs dans les scènes (si elle n'existe pas)
...
-- Table des PNJ dans les scènes (si elle n'existe pas)
...
-- Table des positions des tokens sur les scènes (si elle n'existe pas)
...
-- Table des sorts (si elle n'existe pas)
...
-- Table de liaison personnage-sorts (si elle n'existe pas)
...
-- Table des monstres D&D (si elle n'existe pas)
...
-- Table des objets magiques (si elle n'existe pas)
...
-- Table des poisons (si elle n'existe pas)
...
-- Table des armes (si elle n'existe pas)
...
-- Table des armures (si elle n'existe pas)
...
-- Table de l'équipement des personnages (si elle n'existe pas)
...
-- Table de l'équipement des PNJ (si elle n'existe pas)
...
-- Table de l'équipement des monstres (si elle n'existe pas)
