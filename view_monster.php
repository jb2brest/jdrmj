...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="monster-sheet">
            ...
            <?php
            $accessible_informations = Information::getAccessibleInformations($monster_id, 'Monster');
            
            // Récupérer les groupes (uniquement pour MJ/admin)
            $group_memberships = [];
            if ($isDM) {
                $group_memberships = Groupe::getGroupMemberships($monster_id, 'Monster');
            }
            ?>
            <div class="info-section">
                <?php if ($isDM && !empty($group_memberships)): ?>
                ...
                <h3><i class="fas fa-search me-2"></i>Informations connues</h3>
                
                <?php if (empty($accessible_informations)): ?>
                    <div class="alert alert-info">
                        <i class="fas fa-info-circle me-2"></i>
                        Aucune information accessible pour ce monstre.
                    </div>
                <?php else: ?>
                                ...
                                <?php else: ?>
                                    <?php foreach ($thematique_data['informations'] as $info): ?>
                                        <div class="mb-4 pb-3 border-bottom">
                                            ...
                                            $renderSubInformations = function($sub_infos, $level = 0) use ($isDM) {
                                                if (empty($sub_infos)) {
                                                    return;
                                                }
