...
// Récupération du monstre avec ses détails
// Pour l'instant, on utilise une requête directe car il n'y a pas de classe Monster
$stmt = $pdo->prepare("
    SELECT m.*, mt.name as monster_type_name, u.username as created_by_name, w.name as world_name
    FROM dnd_monsters m
...
$isOwner = ($monsterData['created_by'] == $_SESSION['user_id']);
$isDM = isDM();
...
// Utiliser directement les données du monstre
