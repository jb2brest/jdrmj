<?php
/**
 * API Endpoint: Supprimer un monstre
 */
...
try {
    ...
    $stmt = $pdo->prepare("DELETE FROM place_monsters WHERE id = ?");
    ...
    if ($success) {
        ...
        throw new Exception('Erreur lors de la suppression du monstre');
    }
    
} catch (Exception $e) {
    error_log("Erreur remove_monster.php: " . $e->getMessage());
    echo json_encode([
        'success' => false,
        'error' => $e->getMessage()
    ]);
