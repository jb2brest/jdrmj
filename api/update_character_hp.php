<?php
/**
 * API endpoint pour modifier les points de vie d'un personnage
 */
...
if ($newHp < 0) {
    http_response_code(400);
    echo json_encode(['success' => false, 'message' => 'Points de vie invalides']);
    exit();
}
...
if ($success) {
    echo json_encode([
        'success' => true, 
        'message' => 'Points de vie mis à jour avec succès',
        'new_hp' => $newHp
    ]);
} else {
