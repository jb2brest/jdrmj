...
try {
    ...
    if ($healing <= 0) {
        throw new Exception('Les soins doivent être positifs');
    }
    ...
    echo json_encode([
        'success' => true,
        'message' => "Soins appliqués ({$type_cible}) : {$healing} PV. Points de vie actuels : {$new_hp}",
        'current_hp' => $new_hp,
