...
<head>
    ...
    <title>Ma Collection de Monstres - JDR 4 MJ</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="bestiary.php">Bestiaire</a></li>
                    <li class="nav-item"><a class="nav-link active" href="my_monsters.php">Ma Collection</a></li>
                </ul>
                <ul class="navbar-nav">
