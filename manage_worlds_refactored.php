...
// Fonction helper pour l'upload d'image (conservée pour compatibilité)
            ...
            case 'create_world':
                ...
                if (empty($name)) {
                    ...
                    if (empty($error_message)) {
                        // Utiliser la classe Monde pour créer le monde
...
// Récupérer les mondes de l'utilisateur en utilisant la classe Monde
try {
    $worlds = Monde::findByUser(getPDO(), $user_id);
} catch (Exception $e) {
...
if (isset($_GET['edit']) && is_numeric($_GET['edit'])) {
    ...
    try {
        $edit_world = Monde::findById(getPDO(), $world_id);
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <?php if (!empty($monde->getDescription())): ?>
                                    <p class="card-text text-muted"><?php echo nl2br(htmlspecialchars($monde->getDescription())); ?></p>
                                <?php endif; ?>
                                ...
                                <div class="mt-auto">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <small class="text-muted">
                                            ...
                                            <?php echo date('d/m/Y', strtotime($monde->getCreatedAt())); ?>
                                        </small>
                                    </div>
                                    
                                    <div class="btn-group w-100" role="group">
                                        <a href="view_world.php?id=<?php echo $monde->getId(); ?>" class="btn btn-outline-brown btn-sm">
                                            <i class="fas fa-eye me-1"></i>Voir
                                        </a>
                                        <button class="btn btn-outline-primary btn-sm" onclick="editWorld(<?php echo htmlspecialchars(json_encode($monde->toArray())); ?>)">
                                            <i class="fas fa-edit me-1"></i>Modifier
                                        </button>
                                        <button class="btn btn-outline-danger btn-sm" onclick="deleteWorld(<?php echo $monde->getId(); ?>, '<?php echo htmlspecialchars($monde->getName()); ?>')">
