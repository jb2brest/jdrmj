...
<?php if (!$isModal): ?>
    ...
    window.placeId = <?php echo json_encode($place_id); ?>;
    window.canEdit = <?php echo json_encode($canEdit); ?>;
    window.isOwnerDM = <?php echo json_encode($isOwnerDM); ?>;
    window.tokenPositions = <?php echo json_encode($tokenPositions); ?>;
    window.campaignId = <?php echo json_encode($place['campaign_id']); ?>;
    </script>
