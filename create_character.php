...
$page_title = "Créer un Personnage";
        ...
        try {
            $stmt = $pdo->prepare("
                INSERT INTO characters (
                    ...
                    alignment, skills, languages, money_gold, is_equipped, equipment_locked, character_locked
                ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ");
            ...
            $stmt->execute([
                ...
                $alignment, $skills_json, $languages_json, $backgroundGold,
                0, // is_equipped
                0, // equipment_locked
                0  // character_locked
            ]);
            ...
            $message = displayMessage("Personnage créé avec succès ! Vous pouvez maintenant l'équiper.", "success");
